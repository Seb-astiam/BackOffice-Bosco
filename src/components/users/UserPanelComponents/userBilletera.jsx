...
const UserBilletera = ({ profile, iduser, email }) => {
      ...
      <div className="p-4">
        <div className="bg-white shadow-md rounded">
          <div className="px-4 py-2 border-b border-gray-200">
            <h3 className="text-lg font-semibold">Billetera</h3>
          </div>
          <div className="p-4">
            <form id="profile" className="space-y-4">
              ...
              <div className="mt-4">
                ...
                >
                  {isContentVisible ? 'Ocultar contenido' : 'Cargar Transacciones'}
                </button>
              </div>
            </form>
          </div>
