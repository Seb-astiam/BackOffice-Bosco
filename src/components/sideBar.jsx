      ...
      <ul className="menu flex-grow">
        ...
        <li>
          ...
          <ul className={`submenu ${subMenuState.usuarios ? 'block' : 'hidden'}`}>
            <li><Link to="/usuarios" className="block py-2 px-12 hover:bg-gray-700">Ver Usuarios</Link></li>
            <li><Link to="/usuarios/buscar" className="block py-2 px-12 hover:bg-gray-700">Buscar</Link></li>
            <li><Link to="/usuarios/registro" className="block py-2 px-12 hover:bg-gray-700">Registro Usuario</Link></li>
            <li><Link to="/usuarios/panel-de-usuario" className="block py-2 px-12 hover:bg-gray-700">Panel de Usuario</Link></li>
          </ul>
        </li>
        <li>
        ...
        <li>
          ...
          <ul className={`submenu ${subMenuState.servicios ? 'block' : 'hidden'}`}>
            <li><Link to="/usuarios/services/operations" className="block py-2 px-12 hover:bg-gray-700">Operaciones Servicios</Link></li>
